...
Data analytics and machine learning portfolio covering the full data stack — from SQL database design and Python exploratory analysis to large-scale computing on Databricks and interactive reports in Power BI.

## Projects

**Databricks (Machine Learning)** — fare prediction on 38M+ records using PySpark MLlib (Linear Regression, Random Forest, GBT) and PyTorch neural network, built on Azure Databricks with data stored in Azure Data Lake Storage.
